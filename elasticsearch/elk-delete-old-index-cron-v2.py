...
awsauth = AWS4Auth('xxxxxx', 'yyyyyyy', 'us-east-1', 'es')
...
def get_indices():
    ...
    if ".kibana_2" in indicesList:
        indicesList.remove(".kibana_2")
...
for element in removeElements:
     delete = requests.delete(esEndpoint+indicesList[element], auth=awsauth)
